...
def extract_flat_invoices(ocr_text: str) -> Dict[str, Any]:
    ...
    """
    openai_endpoint = os.getenv("AZURE_OPENAI_ENDPOINT_GPT5_4")
    openai_key = os.getenv("AZURE_OPENAI_API_KEY_GPT5_4")
    deployment_name = os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME_GPT5_4")
    api_version = os.getenv("AZURE_OPENAI_API_VERSION_GPT5_4", "2025-04-01-preview")
